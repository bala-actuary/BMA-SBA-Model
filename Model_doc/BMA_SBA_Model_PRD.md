# Product Requirements Document (PRD): BMA SBA Assessment Model
...
*   The cash flow projections shall be based on the models and assumptions submitted by the insurance groups, as well as on the BMA's own internal models.
...
*   **Performance:** The model shall be able to run complex scenarios and generate reports in a timely manner.
